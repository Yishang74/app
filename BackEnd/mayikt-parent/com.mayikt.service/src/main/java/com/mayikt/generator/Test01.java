...
public class Test01 {
    public static void main(String[] args) {
        FastAutoGenerator.create("jdbc:mysql://localhost:3306/educationaladministrationsystem?useUnicode=true&characterEncoding=UTF-8&serverTimezone=GMT%2B8",
                                 "root", "qq804205093")
            .globalConfig(builder -> {
                builder.author("bruce") // 设置作者
